...
> [https://code.visualstudio.com/updates/v1_106#_chat-modes-renamed-to-custom-agents](https://code.visualstudio.com/updates/v1_106#_chat-modes-renamed-to-custom-agents)
...
![Example of using a predefined prompt with the DevNet Content Search MCP](./images/devnet-content-search-prompt-example.gif)
