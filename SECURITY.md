...
`DevNet Content Search MCP Server` project.
...
The `DevNet Content Search MCP Server` maintainers take all security issues in the project
seriously. Thank you for improving the security of `DevNet Content Search MCP Server`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`DevNet Content Search MCP Server` leverages GitHub's private vulnerability reporting.
